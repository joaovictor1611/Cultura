                    ...
                    <div class="content">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                $q2 = "SELECT * FROM tb_processo,tb_usuario,tb_interessado WHERE tb_processo.tb_usuario_idtb_usuario = tb_usuario.idtb_usuario AND tb_processo.tb_interessado_idtb_interessado = tb_interessado.idtb_interessado AND tb_processo.user_envio = $_SESSION[id1] AND tb_processo.idtb_processo = $idPP AND nome_interessado like '%$pesquisa%' ORDER BY tb_processo.dat_reg DESC";
                                ...
                                <?php include_once 'include/interessado3.php'; ?>

                                <form method="post" action="dao/cad_encaminhar.php" class="form-horizontal">
                                    <div class="panel panel-flat">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <br>
                                            <input type="hidden" name='idd' value="<?php echo $row['idtb_processo']; ?>">
                                            
                                            <input type="hidden" name='quem_enviou' value="<?php echo $_SESSION[id1] ?>">

                                            <input type="hidden" name='interessado' value="<?php echo $_POST['interessado3']; ?> ">
