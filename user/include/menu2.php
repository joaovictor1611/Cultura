                ...
                <div class="sidebar-category sidebar-category-visible">
                    <div class="category-content no-padding">
                        <ul class="navigation navigation-main navigation-accordion">
                            ...
                            <li class="active"><a href="enviar_processo.php"><i class="icon-envelop2"></i> <span>Entrada de processo</span></a></li>
                            ...
                            <li class=""><a class="has-ul" href="#"><i class=" icon-user"></i> <span>Interessado</span></a>
                                <ul class="hidden-ul">
                                    <li class=""><a href="interessado.php">Cadastro</span></a></li>
